...
- `$NGINX_CERT`, `$NGINX_CERT_KEY`, `$NGINX_DH_PARAMS`, and `$NGINX_TRUSTED_CERTS` - set paths where SSL certificate, SSL certificate key, Diffie-Hellman parameters, and trusted CA certificates are located.
